...
def generate_dataset(dir_path, num_clients, niid, balance, partition, alpha=0.5, rawdata_root=None):
...
if __name__ == "__main__":
    ...
    generate_dataset(dir_path, num_clients, niid, balance, partition, alpha, rawdata_root)
