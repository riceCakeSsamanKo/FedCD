...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/baselines_vgg8_mnist_nc50/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
echo "[INFO] All requested MNIST NC50 baseline queue items finished."
