...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/baselines_vgg8_cifar100_nc20/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
algorithms=("Local" "FedAS" "FedKD" "FedAvg" "FedProx" "LG-FedAvg" "Ditto" "FedBN" "FedNTD")
...
echo "[INFO] fl_data root resolves via system/utils/data_utils.py to /home/mulsoap0504/FedCD/fl_data"
echo

for algo in "${algorithms[@]}"; do
    for scenario in "${scenarios[@]}"; do
        dataset="Cifar100_${scenario}"
        goal="${algo}_${scenario}_cifar100_${DATE_STR}_${TIME_STR}"
...
echo "[INFO] All requested baseline queue items finished."
