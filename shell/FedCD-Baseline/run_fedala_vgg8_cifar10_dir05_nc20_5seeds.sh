...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/fedala_vgg8_cifar10_dir05_nc20_5seeds/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
echo "[INFO] FedALA CIFAR-10 dir0.5 NC20 5-seed queue finished."
