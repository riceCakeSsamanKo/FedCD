...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/baselines_vgg8_fashionmnist_dir_only_nc20_parallel/${WORKER_TAG}/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
for algo in "${algorithms[@]}"; do
  for scenario in "${scenarios[@]}"; do
    dataset="FashionMNIST_${scenario}"
