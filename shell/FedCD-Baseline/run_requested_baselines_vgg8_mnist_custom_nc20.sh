...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/baselines_vgg8_mnist_custom_nc20/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
echo "[INFO] All requested MNIST NC20 custom baseline queue items finished."
