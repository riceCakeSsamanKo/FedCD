...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/baselines_vgg8_mnist_dir_only_nc20/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
scenarios=("dir0.1_nc20" "dir0.5_nc20" "dir1.0_nc20")
...
echo "[INFO] All requested MNIST NC20 DIR-only baseline queue items finished."
