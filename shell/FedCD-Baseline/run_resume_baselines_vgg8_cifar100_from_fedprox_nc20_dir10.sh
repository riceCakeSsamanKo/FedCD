...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/baselines_vgg8_cifar100_resume_from_fedprox_nc20_dir10/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
echo "[INFO] Resuming CIFAR-100 baselines from FedProx NC20 dir1.0"
echo
...
# Resume NC20 from the interrupted point: FedProx dir1.0
run_item "FedProx" "dir1.0_nc20" 20

# Continue the remaining NC20 algorithms in the original order.
for algo in LG-FedAvg Ditto FedBN FedNTD; do
