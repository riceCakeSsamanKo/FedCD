...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/cwfedavg_cifar10/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
echo "[INFO] Running cwFedAvg for CIFAR-10"
...
echo "[INFO] Finished cwFedAvg CIFAR-10 queue."
