...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/baselines_vgg8_fashionmnist_dir_only_nc50_parallel/${WORKER_TAG}/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
scenarios=("dir0.1_nc50" "dir0.5_nc50" "dir1.0_nc50")
