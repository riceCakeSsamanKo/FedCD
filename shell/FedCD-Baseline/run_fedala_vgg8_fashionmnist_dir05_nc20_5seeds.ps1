...
$QueueRoot = Join-Path $ScriptDir "batch_runs\fedala_vgg8_fashionmnist_dir05_nc20_5seeds\date_$DateStr\time_$TimeStr"
...
Write-Host "[INFO] FedALA FashionMNIST dir0.5 NC20 5-seed queue finished."
