...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/baselines_vgg8_mnist_nc20/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
algorithms=("Local" "FedAS" "FedKD" "FedAvg" "FedProx" "Ditto" "FedBN" "FedNTD")
...
echo "[INFO] All requested MNIST NC20 baseline queue items finished."
