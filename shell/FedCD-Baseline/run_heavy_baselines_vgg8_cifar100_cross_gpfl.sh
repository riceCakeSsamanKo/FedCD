...
QUEUE_ROOT="$SCRIPT_DIR/batch_runs/heavy_cross_gpfl_cifar100/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
echo "[INFO] Running FedCross + GPFL for CIFAR-100"
...
echo "[INFO] Finished heavy CIFAR-100 queue."
