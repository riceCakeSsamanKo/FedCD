...
QUEUE_ROOT="$REPO_DIR/batch_runs/once_dir05_nc50/date_${DATE_STR}/time_${TIME_STR}"
mkdir -p "$QUEUE_ROOT"
...
run_baseline() {
    local algo="$1"
    shift
    local goal="once_${algo}_dir05_nc50_seed${SEED}_${DATE_STR}_${TIME_STR}"
...
run_ours
echo "[INFO] DIR(0.5) NC50 once queue finished."
